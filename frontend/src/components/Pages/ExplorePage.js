      ...
      <div className="explore-explore-container">
        ...
        <div className="explore-explore-header">
          ...
          <div className="explore-search-container explore-animate-section">
            <input type="text" className="explore-search-input" placeholder="Search for talks, speakers, or topics..." />
        ...
        <section className="explore-explore-section explore-speakers-section explore-animate-section">
          <div className="explore-section-header">
            ...
            <a href="#" className="explore-view-all">View All Speakers</a>
          </div>
          <div className="explore-speakers-grid">
            {featuredSpeakers.map(speaker => (
              <div className="explore-speaker-card" key={speaker.id}>
                <div className="explore-speaker-image">
                  <img src={img3} alt={speaker.name} />
                </div>
                <div className="explore-speaker-info">
                  <h3>{speaker.name}</h3>
                  <p className="explore-speaker-specialty">{speaker.specialty}</p>
                  <p className="explore-talks-count">{speaker.talks} talks</p>
                  <button className="explore-view-speaker-btn">View Talks</button>
                </div>
              </div>
            ))}
          </div>
