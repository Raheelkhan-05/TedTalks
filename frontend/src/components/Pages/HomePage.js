      ...
      <section className="categories-section tos-animate-section">
        ...
        <div className="categories-cards">
          <div className="category-card">
            ...
            <h3>Technology</h3>
            <p>
              Explore the latest in AI, robotics, and digital innovation that's shaping our future.
            </p>
          ...
          <div className="category-card">
            ...
            <h3>Science</h3>
            <p>
              Discover groundbreaking research and scientific breakthroughs changing our understanding.
            </p>
            <a href="#" className="explore-button">Explore</a>
          </div>
          ...
          <div className="category-card">
            ...
            <h3>Psychology</h3>
            <p>
              Understand human behavior, mental health, and the mysteries of the mind.
            </p>
            <a href="#" className="explore-button">Explore</a>
          </div>
        </div>
